 ...
 */
$mailTo     = 'dbanegasl@gmail.com';

/**
 * Set the message that will be shown on success
 */
$successMsg = 'Gracias, mensaje enviado correctamente!';

/**
 * Set the message that will be shown if not all fields are filled
 */
$fillMsg    = 'Llene todos los campos!';

/**
 * Set the message that will be shown on error
 */
$errorMsg   = 'Hay algun problema, lo sentimos!';
...
if (
	...
	if (!preg_match("/^[a-zA-Z ]*$/", $_POST['contact-name']) == false) {
		...
		if (isset($_POST['textarea-message']) && $_POST['textarea-message'] != '') {
			$msg .= "Message: " . $_POST['textarea-message'] . "\r\n";
		}
		...
		$json_arr = array("type" => "error", "msg" => "Solo letras o espacios en blanco!");
		echo json_encode($json_arr);
	}
}
